...
public class ESJSONArray implements JSONArray {

    private final me.yufan.elasticsearch.common.json.esjson.core.JSONArray jsonArray;

    public ESJSONArray(@NonNull me.yufan.elasticsearch.common.json.esjson.core.JSONArray jsonArray) {
    ...
    public JSONObject getJSONObject(int index) {
        return new ESJSONObject(jsonArray.getJSONObject(index));
    }

    @Override
    public JSONArray getJSONArray(int index) {
        return new ESJSONArray(jsonArray.getJSONArray(index));
    }
