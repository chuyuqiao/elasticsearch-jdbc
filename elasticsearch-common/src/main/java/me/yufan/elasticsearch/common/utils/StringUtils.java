...
/**
 * Utils Class, only used for reduce dependency. Because using a one-method-dependency
 * for the simplicity's sake in the long run can resulting in a jar-hell.
 *
 * Original source from commons-langs3
 */
@UtilityClass
