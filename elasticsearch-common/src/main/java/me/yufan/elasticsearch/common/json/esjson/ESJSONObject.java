...
public class ESJSONObject implements JSONObject {

    private me.yufan.elasticsearch.common.json.esjson.core.JSONObject jsonObject;

    public ESJSONObject(@NonNull me.yufan.elasticsearch.common.json.esjson.core.JSONObject jsonObject) {
    ...
    public JSONObject getJSONObject(String key) {
        return new ESJSONObject(jsonObject.getJSONObject(key));
    }

    @Override
    public JSONArray getJSONArray(String key) {
        return new ESJSONArray(jsonObject.getJSONArray(key));
    }
